...
export default async function CommunityDetailPage({
  ...
  return (
    <div className={communityPageShell}>
      ...
      {post.type !== "trade" && post.description ? (
        <section className={`${communityCardClass} p-5 sm:p-6`} aria-label="Description">
      ...
      {post.type !== "trade" && (
        <section className={`${communityCardClass} p-5 sm:p-6`} aria-label="Images">
          {imageUrls.length === 0 ? (
            <p className="text-sm text-stone-500">No images.</p>
          ) : (
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
